      ...
      <h5 className='p-1 text-center w-[93%] absolute top-2'><i onClick={()=>{
        ...
        <div className='flex items-center justify-between p-4 border-2 border-yellow-400 rounded-lg mt-4'>
            <div className='flex items-center gap-3'>
                ...
                <h2 className='text-lg font-medium'>Jeet Wasti</h2>
            </div>
        ...
        {/* <img className='h-20' src="https://www.pngplay.com/wp-content/uploads/8/Uber-PNG-Photos.png" alt="" /> */}
            ...
            <Link to='/captain-home' className='w-full flex justify-center text-lg bg-green-600 text-white font-semibold p-3 rounded-lg mt-5'>Finish Ride</Link>
